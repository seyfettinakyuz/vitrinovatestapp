...
import com.seyfettin.vitrinovaapplication.databinding.ItemAllCollectionBinding;
...
public class CollectionAllListAdapter extends BaseAdapter<CollectionAllListAdapter.ViewHolder, Collection> {

    private List<Collection> data;
    private int lastPosition = -1;


    public CollectionAllListAdapter() {
        data = new ArrayList<>();
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        private static ViewHolder create(LayoutInflater inflater, ViewGroup parent) {
            ItemAllCollectionBinding itemBinding = ItemAllCollectionBinding.inflate(inflater, parent, false);
            return new ViewHolder(itemBinding);
        }

        final ItemAllCollectionBinding binding;

        private ViewHolder(ItemAllCollectionBinding binding) {
